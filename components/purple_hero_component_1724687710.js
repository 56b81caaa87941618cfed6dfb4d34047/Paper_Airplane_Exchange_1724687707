  ...
  <section id="hero-section-container">
    <div id="section-container" class="relative max-w-6xl mx-auto px-4 sm:px-6 bg-gradient-to-br from-pink-500 to-purple-700">
      <div id="hero-content-container" class="pt-32 pb-16 md:pt-52 md:pb-32">
        <!-- Hero content -->
        <div id="hero-content" class="max-w-3xl mx-auto text-center bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg p-8" style="position: relative; z-index: 1">
          <div id="announcement-text" class="mb-6" data-aos="fade-down">
              ...
              <a id="announcement-link" class="flex-1 btn-sm py-0.5 transition duration-150 ease-in-out group relative before:absolute before:inset-0 before:rounded-full before:pointer-events-none shadow text-white hover:text-pink-200 before:bg-purple-800/50" 
                 href="#0" 
                 style="background: linear-gradient(theme(colors.pink.500), theme(colors.purple.700)) padding-box, linear-gradient(theme(colors.pink.500), theme(colors.purple.200) 75%, theme(colors.transparent) 100%) border-box;">
          ...
          <div class="flex" id="hero-text-container">
            <h1 id="hero-text" class="h1 bg-clip-text text-transparent bg-gradient-to-r from-pink-300 via-purple-300 to-pink-300 pb-4" data-aos="fade-down">Soar into the World of Paper Airplane Trading</h1>
          </div>
          <div class="flex" id="sub-hero-text-container">
            <p id="sub-hero-text" class="flex-1 text-lg mb-8 text-pink-100" data-aos="fade-down" data-aos-delay="200">Buy, sell, and trade unique paper airplane designs in our vibrant community marketplace. From simple gliders to complex aerobatic marvels, find your perfect flight!</p>
          </div>
