      ...
      <div id="hero-content-container" class="pt-32 pb-16 md:pt-52 md:pb-32">
        ...
        <div id="hero-content" class="max-w-3xl mx-auto text-center" style="position: relative; z-index: 1">
          ...
          <div class="flex" id="hero-text-container">
            <h1 id="hero-text" class="h1 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4" data-aos="fade-down">Soar into the World of Paper Airplane Trading</h1>
          </div>
          <div class="flex" id="sub-hero-text-container">
            <p id="sub-hero-text" class="flex-1 text-lg mb-8 text-slate-300" data-aos="fade-down" data-aos-delay="200">Buy, sell, and trade unique paper airplane designs in our vibrant community marketplace. From simple gliders to complex aerobatic marvels, find your perfect flight!</p>
          </div>
