      ...
      <div class="flex items-center justify-between h-16 md:h-20">
        ...
        <ul id="desktop-sign-in-links" class="flex-1 flex justify-end items-center">
          ...
          <li class="ml-6">
            <button
              id="hadoken-button"
              class="btn-sm transition duration-150 ease-in-out w-full group relative text-white hover:text-pink-200 bg-blue-600 bg-opacity-50 hover:bg-opacity-70 rounded-full px-4 py-2"
              @click="performHadoken"
            >
              <span class="relative inline-flex items-center">
                Hadoken
                <i class='bx bx-meteor ml-2'></i>
              </span>
            </button>
          </li>
        </ul>
        ...
        <div class="md:hidden flex items-center ml-4">
          ...
          <nav
            ...
            x-cloak
          >
            <ul id="mobile-nav-list" class="rounded-lg px-4 py-1.5 bg-gradient-to-r from-pink-500 to-purple-600 bg-opacity-50 backdrop-filter backdrop-blur-lg shadow-lg">
              <li>
              ...
              <li>
                <a id="mobile-Design Studio-link" class="flex font-medium text-sm py-1.5 text-white hover:text-pink-200" href="Design Studio.html">Design Studio</a>
              </li>
              <li>
              ...
              <li>
                <a id="mobile-Login-link" class="flex font-medium text-sm py-1.5 text-white hover:text-pink-200" href="Login.html">Login</a>
              </li>
            </ul>
          </nav>
        </div>
