            ...
            <div id="footer-logo-copyright" class="mb-4 sm:mb-0">
              <div class="mb-4">
                ...
                <a
                  ...
                  class="inline-flex"
                  href="index.html"
                  aria-label="© 2023 AirTraders. All rights reserved."
                >
                  <img src="./images/logo.svg" width="38" height="38" alt="Stellar" />
                </a>
              </div>
              <div id="footer-copyright" class="text-sm text-white">
                © 2023 AirTraders. All rights reserved.
                <span class="text-pink-300">-</span> All rights reserved.
              </div>
            </div>
            <!-- Social links -->
          ...
          <ul id="footer-block-2-list" class="text-sm space-y-2">
            <li>
              <a
                ...
                class="transition duration-150 ease-in-out text-white hover:text-pink-300"
                href="#0"
              >
                Our Story
              </a>
...
<script>
export default {
  name: "dark_footer_component_1724687710",
  data() {
    return {
      expanded: false,
      tab: null,
