...
<template>
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-purple-900 bg-opacity-30 backdrop-filter backdrop-blur-lg p-8 rounded-lg shadow-lg">
        <!-- Feature 1 -->
        <div id="feature-1">
            <div id="feature-1-header" class="flex items-center space-x-2 mb-1">
               ...
               <div class="flex" id="feature-1-title-container">
                    <h4 id="feature-1-title" class="flex-1 text-pink-300 font-medium">Soar into Trading</h4>
                </div>
            </div>
            <div class="flex" id="feature-1-description-container">
                <p id="feature-1-description" class="flex-1 text-sm text-purple-100">Join our vibrant marketplace dedicated to paper airplane enthusiasts. Buy, sell, and trade unique designs with ease.</p>
            </div>
        </div>
        ...
        <div id="feature-2">
            <div id="feature-2-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-2-title-container">
                    <h4 id="feature-2-title" class="flex-1 text-pink-300 font-medium">Fold Your Fortune</h4>
                </div>
            </div>
            <div class="flex" id="feature-2-description-container">
                <p id="feature-2-description" class="flex-1 text-sm text-purple-100">Turn your paper creations into profit. List your handcrafted planes and reach a global community of collectors and hobbyists.</p>
            </div>
        </div>
        ...
        <div id="feature-3">
            <div id="feature-3-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-3-title-container">
                    <h4 id="feature-3-title" class="flex-1 text-pink-300 font-medium">Discover Rare Designs</h4>
                </div>
            </div>
            <div class="flex" id="feature-3-description-container">
                <p id="feature-3-description" class="flex-1 text-sm text-purple-100">Explore a vast catalog of paper airplanes, from classic dart designs to intricate origami-inspired models.</p>
            </div>
        </div>
        ...
        <div id="feature-4">
            <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-4-title-container">
                    <h4 id="feature-4-title" class="flex-1 text-pink-300 font-medium">Secure Transactions</h4>
                </div>
            </div>
            <div class="flex" id="feature-4-description-container">
                <p id="feature-4-description" class="flex-1 text-sm text-purple-100">Trade with confidence using our safe and transparent payment system, protecting both buyers and sellers.</p>
            </div>
        </div>
        ...
        <div id="feature-5">
            <div id="feature-5-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-5-title-container">
                    <h4 id="feature-5-title" class="flex-1 text-pink-300 font-medium">Community Take-Off</h4>
                </div>
            </div>
            <div class="flex" id="feature-5-description-container">
                <p id="feature-5-description" class="flex-1 text-sm text-purple-100">Connect with fellow enthusiasts, share tips, and participate in forums to elevate your paper airplane passion.</p>
            </div>
        </div>
        ...
        <div id="feature-6">
            <div id="feature-6-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-6-title-container">
                    <h4 id="feature-6-title" class="flex-1 text-pink-300 font-medium">Flight School</h4>
                </div>
            </div>
            <div class="flex" id="feature-6-description-container">
                <p id="feature-6-description" class="flex-1 text-sm text-purple-100">Learn from expert tutorials, improve your folding techniques, and master the art of paper airplane creation.</p>
            </div>
        </div>
    </div>
</template>
